...
const defaultSkills: SkillCategory[] = [
  { id: "1", name: "Frontend", icon: "Globe", color: "#00ffff", items: ["React", "Next.js", "Vue 3", "TypeScript", "Tailwind CSS"] },
  { id: "2", name: "Backend", icon: "Database", color: "#ff00ff", items: ["Node.js", "Fastify", "PostgreSQL", "MongoDB", "Supabase"] },
  { id: "3", name: "Game Dev", icon: "Gamepad2", color: "#00ff00", items: ["Babylon.js", "Colyseus", "WebSocket", "Three.js", "Multiplayer"] },
...
export function AboutContent({ founder, team, testimonials, testimonialStats, skillCategories }: AboutContentProps) {
  ...
  return (
    <>
      ...
      {/* Testimonials */}
      <Testimonials testimonials={testimonials} stats={testimonialStats} />
